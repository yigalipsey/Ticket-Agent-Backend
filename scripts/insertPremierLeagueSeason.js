...
class PremierLeagueSeasonInserter {
  constructor() {
  ...
  async run() {
    try {
      console.log(
        "\n🏴󠁧󠁢󠁥󠁮󠁧󠁿 PREMIER LEAGUE SEASON 2025/2026 - FROM OCTOBER 9, 2025 🏴󠁧󠁢󠁥󠁮󠁧󠁿\n"
      );
...
if (import.meta.url === `file://${process.argv[1]}`) {
  const inserter = new PremierLeagueSeasonInserter();
...
export default PremierLeagueSeasonInserter;
