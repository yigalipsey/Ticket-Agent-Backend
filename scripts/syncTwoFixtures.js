...
async function syncTwoFixtures() {
  try {
    logWithCheckpoint("info", "Starting fixture sync", "SYNC_004");
    ...
    logWithCheckpoint("info", "Fixture sync completed", "SYNC_009");
    ...
    logError(error, { operation: "syncTwoFixtures" });
    process.exit(1);
  } finally {
